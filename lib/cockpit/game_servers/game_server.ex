defmodule Cockpit.GameServers.GameServer do
  ...
  def changeset(game_server, attrs) do
    game_server
    |> cast(attrs, [:bind, :dest, :internal_ip, :a2s_info_cache, :cache_time, :bind_port, :dest_port])
    |> validate_required([:bind, :dest, :internal_ip, :a2s_info_cache, :cache_time, :bind_port, :dest_port])
